(function () {
    ...
    angular.module('moderator', [
        ...
        .controller('ModeratorController', ['$scope', '$routeParams', 'currentAuth', 'PollerizeSession', function ($scope, $routeParams, Auth, Session) {
                ...
                function() {
                    ...
                    if(typeof $scope.data.questions === 'undefined') {
                        ...
                        $scope.data.questions[0] = {
                            active: false,
                            answers: [{color: "#3F51B5", responses: 0, text: "Default Answer"}],
